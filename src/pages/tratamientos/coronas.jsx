// src/pages/tratamientos/coronas.jsx
...
export default function Coronas() {
    const { t } = useTranslation("home");
    const navigate = useNavigate();

    const getWaUrl = (serviceKey, serviceTitle) => {
        const base = "https://wa.me/523333087833";
        const text = encodeURIComponent(`Hola me gustaria agendar una cita para ${serviceTitle || "coronas dentales"}`);
    ...
    return (
        <>
            <SEO
                title="Coronas Dentales | Dental City"
                description="Coronas dentales de cerámica y zirconia en Zapopan, Guadalajara. Rehabilitación estética y resistente de dientes dañados con tecnología digital. Consulta nuestros precios."
                keywords="coronas dentales, coronas cerámica, coronas zirconia, rehabilitación dental, restauración dental, coronas Zapopan, coronas Guadalajara"
            />
            <StructuredData
                type="MedicalProcedure"
                data={{
                    name: "Coronas Dentales",
                    description: "Rehabilitación resistente y estética de dientes dañados con material cerámico/zirconia y ajuste digital",
                    provider: {
                        name: "Dental City",
                        address: {
                ...
                <section className="relative overflow-hidden bg-gradient-to-b from-[#0f2237] via-[#0b1b2b] to-[#0f2237]">
                    ...
                    <Container className="py-16 md:py-24 relative z-10">
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            >
                                Rehabilitación resistente y estética de dientes dañados. Restaura la funcionalidad y belleza de tu sonrisa con coronas de alta calidad.
                            </motion.p>
                        </div>
                    </Container>
                </section>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            >
                                ...
                                <div className="space-y-4 text-white/80 leading-relaxed text-lg">
                                    ...
                                    <p>
                                        En Dental City utilizamos materiales de la más alta calidad como <strong className="text-[#e4b892]">cerámica</strong> y <strong className="text-[#e4b892]">zirconia</strong>, que ofrecen una apariencia natural y una durabilidad excepcional. Nuestro proceso incluye tecnología digital para un ajuste perfecto y resultados estéticos superiores.
                                    </p>
                                </div>
                            </motion.div>
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: "El diente se prepara removiendo la parte dañada y dándole la forma adecuada para recibir la corona."
                                        },
                                        {
                                            step: "2",
                                            title: "Toma de Impresiones Digitales",
                                            desc: "Utilizamos tecnología de escaneo digital 3D para crear un modelo preciso de tu diente y diseñar la corona perfecta."
                                        },
                                        {
                                            step: "3",
                                            title: "Corona Temporal",
                                            desc: "Se coloca una corona temporal mientras se fabrica la definitiva, protegiendo el diente preparado."
                                        },
                                        {
                                            step: "4",
                                            title: "Colocación de la Corona Definitiva",
                                            desc: "Una vez lista, la corona definitiva se ajusta, se verifica la oclusión y se cementa de forma permanente."
                                        }
                                    ].map((item, idx) => (
                                        <motion.div
                                            key={idx}
                            ...
                            >
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-white/80">2 citas de 60-90 minutos cada una</p>
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold text-[#e4b892] mb-2">Precio Estimado</h3>
                                        <p className="text-white/80">$9,000 - $10,000 MXN por pieza</p>
                            ...
                            >
                                <a
                                    href={getWaUrl("coronas", "Coronas Dentales")}
                                    target="_blank"
