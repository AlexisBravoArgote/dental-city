// src/pages/tratamientos/periodoncia.jsx
...
export default function Periodoncia() {
    ...
    const getWaUrl = (serviceKey, serviceTitle) => {
        ...
        const text = encodeURIComponent(`Hola me gustaria agendar una cita para ${serviceTitle || "periodoncia"}`);
    ...
    return (
        <>
            <SEO
                title="Periodoncia | Dental City"
                description="Periodoncia en Zapopan, Guadalajara. Cuidado integral de encías y soporte óseo. Terapia periodontal no quirúrgica y mantenimiento. Consulta nuestros precios."
                keywords="periodoncia, enfermedad periodontal, encías, gingivitis, periodontitis, tratamiento de encías, periodoncia Zapopan"
            />
            <StructuredData
                type="MedicalProcedure"
                data={{
                    name: "Periodoncia",
                    description: "Cuidado integral de encías y soporte óseo mediante terapia periodontal no quirúrgica y mantenimiento",
                    provider: {
                        name: "Dental City",
                        address: {
                ...
                <section className="relative overflow-hidden bg-gradient-to-b from-[#0f2237] via-[#0b1b2b] to-[#0f2237]">
                    ...
                    <Container className="py-16 md:py-24 relative z-10">
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            >
                                Cuidado integral de encías y soporte óseo. Prevención y tratamiento de enfermedades periodontales para mantener tu salud bucal.
                            </motion.p>
                        </div>
                    </Container>
                </section>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            >
                                ...
                                <div className="space-y-4 text-white/80 leading-relaxed text-lg">
                                    ...
                                    <p>
                                        Las enfermedades periodontales, como la gingivitis y la periodontitis, pueden causar inflamación, sangrado de encías, y en casos avanzados, pérdida de dientes. En Dental City ofrecemos <strong className="text-[#e4b892]">terapia periodontal no quirúrgica</strong> y <strong className="text-[#e4b892]">mantenimiento</strong> especializado para mantener tus encías saludables.
                                    </p>
                                </div>
                            </motion.div>
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: "Examen completo de encías, medición de bolsas periodontales y evaluación del estado de los tejidos de soporte."
                                        },
                                        {
                                            step: "2",
                                            title: "Raspado y Alisado Radicular",
                                            desc: "Limpieza profunda para remover placa y sarro de las raíces dentales y debajo de la línea de las encías."
                                        },
                                        {
                                            step: "3",
                                            title: "Terapia Adicional",
                                            desc: "En casos necesarios, se pueden realizar procedimientos adicionales como alargamiento de corona o cirugía periodontal."
                                        },
                                        {
                                            step: "4",
                                            title: "Mantenimiento Periódico",
                                            desc: "Seguimiento regular con limpiezas profundas para mantener la salud periodontal y prevenir recaídas."
                                        }
                                    ].map((item, idx) => (
                                        <motion.div
                                            key={idx}
                            ...
                            >
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-white/80">60-90 minutos por cuadrante</p>
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold text-[#e4b892] mb-2">Precio Estimado</h3>
                                        <p className="text-white/80">$1,500 - $3,000 MXN (mantenimiento)</p>
                                        <p className="text-white/80">$4,200 MXN (alargamiento de corona)</p>
                            ...
                            >
                                <a
                                    href={getWaUrl("periodoncia", "Periodoncia")}
                                    target="_blank"
