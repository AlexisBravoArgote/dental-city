// src/pages/tratamientos/carillas.jsx
...
export default function Carillas() {
    const { t } = useTranslation("home");
    const navigate = useNavigate();

    const getWaUrl = (serviceKey, serviceTitle) => {
        const base = "https://wa.me/523333087833";
        const text = encodeURIComponent(`Hola me gustaria agendar una cita para ${serviceTitle || "carillas dentales"}`);
    ...
    return (
        <>
            <SEO
                title="Carillas Dentales | Dental City"
                description="Carillas dentales en Zapopan, Guadalajara. Láminas estéticas de cerámica o resina para forma y color perfectos. Consulta nuestros precios."
                keywords="carillas dentales, carillas cerámica, carillas resina, láminas dentales, estética dental, carillas Zapopan"
            />
            <StructuredData
                type="MedicalProcedure"
                data={{
                    name: "Carillas Dentales",
                    description: "Láminas estéticas para forma y color perfectos mediante carillas de cerámica o resina con mínima preparación según el caso",
                    provider: {
                        name: "Dental City",
                        address: {
                ...
                <section className="relative overflow-hidden bg-gradient-to-b from-[#0f2237] via-[#0b1b2b] to-[#0f2237]">
                    ...
                    <Container className="py-16 md:py-24 relative z-10">
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            >
                                Láminas estéticas para forma y color perfectos. Transforma tu sonrisa con carillas de cerámica o resina personalizadas.
                            </motion.p>
                        </div>
                    </Container>
                </section>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            >
                                ...
                                <div className="space-y-4 text-white/80 leading-relaxed text-lg">
                                    ...
                                    <p>
                                        En Dental City ofrecemos carillas de <strong className="text-[#e4b892]">cerámica</strong> y <strong className="text-[#e4b892]">resina</strong>, con <strong className="text-[#e4b892]">mínima preparación</strong> según el caso. Cada carilla se diseña y fabrica de forma personalizada para lograr resultados naturales y duraderos.
                                    </p>
                                </div>
                            </motion.div>
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: "Evaluación de tu sonrisa y diseño digital de las carillas para visualizar el resultado final."
                                        },
                                        {
                                            step: "2",
                                            title: "Preparación del Diente",
                                            desc: "Preparación mínima del diente (si es necesaria) para crear espacio para la carilla."
                                        },
                                        {
                                            step: "3",
                                            title: "Toma de Impresiones",
                                            desc: "Impresiones precisas o escaneo digital para fabricar las carillas personalizadas en el laboratorio."
                                        },
                                        {
                                            step: "4",
                                            title: "Colocación de Carillas",
                                            desc: "Las carillas se adhieren permanentemente a los dientes con un cemento especial de alta resistencia."
                                        }
                                    ].map((item, idx) => (
                                        <motion.div
                                            key={idx}
                            ...
                            >
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-white/80">2-3 citas</p>
                                        <p className="text-white/80 text-sm">Laboratorio: 7-14 días</p>
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold text-[#e4b892] mb-2">Precio Estimado</h3>
                                        <p className="text-white/80">$6,000 - $12,000 MXN por pieza</p>
                                        <p className="text-sm text-white/60 mt-1">*Precio varía según el material</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            >
                                <a
                                    href={getWaUrl("carillas", "Carillas Dentales")}
                                    target="_blank"
