// src/pages/tratamientos/armonizacion-facial.jsx
...
export default function ArmonizacionFacial() {
    ...
    const getWaUrl = (serviceKey, serviceTitle) => {
        ...
        const text = encodeURIComponent(`Hola me gustaria agendar una cita para ${serviceTitle || "armonización facial"}`);
    ...
    return (
        <>
            <SEO
                title="Armonización Facial | Dental City"
                description="Armonización facial en Zapopan, Guadalajara. Toxina botulínica y rellenos dérmicos para equilibrio facial natural. Botox para bruxismo. Consulta nuestros precios."
                keywords="armonización facial, botox, toxina botulínica, rellenos dérmicos, botox bruxismo, estética facial, armonización Zapopan"
            />
            <StructuredData
                type="MedicalProcedure"
                data={{
                    name: "Armonización Facial",
                    description: "Toxina botulínica y rellenos dérmicos para equilibrio facial natural mediante atenuación de líneas y realce de volumen sutil",
                    provider: {
                        name: "Dental City",
                        address: {
                ...
                <section className="relative overflow-hidden bg-gradient-to-b from-[#0f2237] via-[#0b1b2b] to-[#0f2237]">
                    ...
                    <Container className="py-16 md:py-24 relative z-10">
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            >
                                Toxina botulínica y rellenos dérmicos para equilibrio facial natural. Realza y equilibra tus rasgos faciales de forma sutil y natural.
                            </motion.p>
                        </div>
                    </Container>
                </section>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            >
                                ...
                                <div className="space-y-4 text-white/80 leading-relaxed text-lg">
                                    ...
                                    <p>
                                        Estos procedimientos permiten <strong className="text-[#e4b892]">atenuar líneas de expresión</strong>, <strong className="text-[#e4b892]">realzar volumen</strong> de forma sutil, y también pueden utilizarse para tratar el bruxismo mediante la aplicación de Botox en los músculos maseteros. Los resultados son naturales y pueden durar de 4 a 12 meses según el tratamiento.
                                    </p>
                                </div>
                            </motion.div>
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: "Atenuación de líneas de expresión, tratamiento de bruxismo, y relajación de músculos faciales para un aspecto más joven y relajado."
                                        },
                                        {
                                            step: "2",
                                            title: "Rellenos Dérmicos",
                                            desc: "Realce de volumen sutil en labios, mejillas y otras áreas faciales para lograr equilibrio y armonía natural."
                                        },
                                        {
                                            step: "3",
                                            title: "Botox para Bruxismo",
                                            desc: "Aplicación específica de toxina botulínica en músculos maseteros para reducir el apretamiento y rechinamiento dental."
                                        }
                                    ].map((item, idx) => (
                                        <motion.div
                                            key={idx}
                            ...
                            >
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-white/80">20-40 minutos</p>
                                        <p className="text-white/80 text-sm">Resultados: 4-12 meses</p>
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold text-[#e4b892] mb-2">Precio Estimado</h3>
                                        <p className="text-white/80">$5,000 MXN (Botox Bruxismo)</p>
                                        <p className="text-white/80">$2,800 MXN (Baby Botox)</p>
                                        <p className="text-sm text-white/60 mt-1">*Precio por zona</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            >
                                <a
                                    href={getWaUrl("armonizacion-facial", "Armonización Facial")}
                                    target="_blank"
