// src/pages/tratamientos/extracciones.jsx
...
export default function Extracciones() {
    ...
    const getWaUrl = (serviceKey, serviceTitle) => {
        ...
        const text = encodeURIComponent(`Hola me gustaria agendar una cita para ${serviceTitle || "extracción dental"}`);
    ...
    return (
        <>
            <SEO
                title="Extracciones Dentales | Dental City"
                description="Extracciones dentales en Zapopan, Guadalajara. Extracciones simples y de cordales con enfoque mínimamente invasivo. Consulta nuestros precios."
                keywords="extracciones dentales, muelas del juicio, extracción Zapopan, extracción Guadalajara, cirugía dental"
            />
            <StructuredData
                type="MedicalProcedure"
                data={{
                    name: "Extracciones Dentales",
                    description: "Extracciones simples y de cordales con enfoque mínimamente invasivo, anestesia local y manejo postoperatorio",
                    provider: {
                        name: "Dental City",
                        address: {
                ...
                <section className="relative overflow-hidden bg-gradient-to-b from-[#0f2237] via-[#0b1b2b] to-[#0f2237]">
                    ...
                    <Container className="py-16 md:py-24 relative z-10">
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            >
                                Extracciones simples y de cordales con enfoque mínimamente invasivo. Procedimiento seguro y cómodo con anestesia local.
                            </motion.p>
                        </div>
                    </Container>
                </section>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            >
                                ...
                                <div className="space-y-4 text-white/80 leading-relaxed text-lg">
                                    ...
                                    <p>
                                        En Dental City realizamos extracciones con un <strong className="text-[#e4b892]">enfoque mínimamente invasivo</strong>, utilizando <strong className="text-[#e4b892]">anestesia local</strong> para garantizar tu comodidad y proporcionando un <strong className="text-[#e4b892]">manejo postoperatorio</strong> adecuado para una recuperación rápida y sin complicaciones.
                                    </p>
                                </div>
                            </motion.div>
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: "Radiografías y examen clínico para evaluar la posición del diente y planificar la extracción."
                                        },
                                        {
                                            step: "2",
                                            title: "Anestesia Local",
                                            desc: "Aplicación de anestesia local para garantizar que no sientas dolor durante el procedimiento."
                                        },
                                        {
                                            step: "3",
                                            title: "Extracción",
                                            desc: "Procedimiento realizado con técnicas mínimamente invasivas para remover el diente de forma segura."
                                        },
                                        {
                                            step: "4",
                                            title: "Cuidados Postoperatorios",
                                            desc: "Instrucciones detalladas y seguimiento para asegurar una recuperación adecuada y sin complicaciones."
                                        }
                                    ].map((item, idx) => (
                                        <motion.div
                                            key={idx}
                            ...
                            >
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-white/80">20-60 minutos</p>
                                        <p className="text-white/80 text-sm">Según complejidad</p>
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold text-[#e4b892] mb-2">Precio Estimado</h3>
                                        <p className="text-white/80">$2,000 MXN (Incisivo)</p>
                                        <p className="text-white/80">$3,000 MXN (Muelas del juicio)</p>
                            ...
                            >
                                <a
                                    href={getWaUrl("extracciones", "Extracciones Dentales")}
                                    target="_blank"
