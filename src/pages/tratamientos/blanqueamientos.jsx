// src/pages/tratamientos/blanqueamientos.jsx
...
export default function Blanqueamientos() {
    const { t } = useTranslation("home");
    const navigate = useNavigate();

    const getWaUrl = (serviceKey, serviceTitle) => {
        const base = "https://wa.me/523333087833";
        const text = encodeURIComponent(`Hola me gustaria agendar una cita para ${serviceTitle || "blanqueamiento dental"}`);
    ...
    return (
        <>
            <SEO
                title="Blanqueamiento Dental | Dental City"
                description="Blanqueamiento dental seguro y efectivo en Zapopan, Guadalajara. Aclarado del tono dental en clínica y/o domiciliario supervisado. Consulta nuestros precios."
                keywords="blanqueamiento dental, blanqueamiento Zapopan, blanqueamiento Guadalajara, aclarado dental, blanqueamiento clínico"
            />
            <StructuredData
                type="MedicalProcedure"
                data={{
                    name: "Blanqueamiento Dental",
                    description: "Aclarado seguro y efectivo del tono dental mediante tratamiento en clínica y/o domiciliario supervisado",
                    provider: {
                        name: "Dental City",
                        address: {
                ...
                <section className="relative overflow-hidden bg-gradient-to-b from-[#0f2237] via-[#0b1b2b] to-[#0f2237]">
                    ...
                    <Container className="py-16 md:py-24 relative z-10">
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            >
                                Aclarado seguro y efectivo del tono dental. Logra una sonrisa más blanca y radiante con nuestro tratamiento profesional.
                            </motion.p>
                        </div>
                    </Container>
                </section>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            >
                                ...
                                <div className="space-y-4 text-white/80 leading-relaxed text-lg">
                                    ...
                                    <p>
                                        En Dental City ofrecemos tratamientos de blanqueamiento <strong className="text-[#e4b892]">en clínica</strong> y/o <strong className="text-[#e4b892]">domiciliario supervisado</strong>, adaptados a tus necesidades específicas. Utilizamos productos seguros y efectivos que proporcionan resultados visibles en poco tiempo.
                                    </p>
                                </div>
                            </motion.div>
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: "Tratamiento realizado en nuestra clínica con productos de alta concentración y luz especializada para resultados inmediatos."
                                        },
                                        {
                                            step: "2",
                                            title: "Blanqueamiento Domiciliario",
                                            desc: "Tratamiento supervisado que realizas en casa con férulas personalizadas y gel blanqueador proporcionado por nuestro equipo."
                                        },
                                        {
                                            step: "3",
                                            title: "Tratamiento Combinado",
                                            desc: "Combinación de ambos métodos para obtener los mejores resultados: sesión inicial en clínica seguida de mantenimiento en casa."
                                        }
                                    ].map((item, idx) => (
                                        <motion.div
                                            key={idx}
                            ...
                            >
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-white/80">45-60 minutos por sesión</p>
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold text-[#e4b892] mb-2">Precio Estimado</h3>
                                        <p className="text-white/80">$3,900 MXN (completo)</p>
                                        <p className="text-white/80">$1,500 MXN (retoque)</p>
                            ...
                            >
                                <a
                                    href={getWaUrl("blanqueamientos", "Blanqueamiento Dental")}
                                    target="_blank"
