// src/pages/tratamientos/endodoncia.jsx
...
export default function Endodoncia() {
    ...
    const getWaUrl = (serviceKey, serviceTitle) => {
        ...
        const text = encodeURIComponent(`Hola me gustaria agendar una cita para ${serviceTitle || "endodoncia"}`);
    ...
    return (
        <>
            <SEO
                title="Endodoncia | Dental City"
                description="Tratamiento de conductos (endodoncia) en Zapopan, Guadalajara. Conserva tus dientes naturales con desinfección, conformación y sellado del conducto. Consulta nuestros precios."
                keywords="endodoncia, tratamiento de conductos, endodoncia Zapopan, endodoncia Guadalajara, tratamiento de raíz, conservación dental"
            />
            <StructuredData
                type="MedicalProcedure"
                data={{
                    name: "Endodoncia",
                    description: "Tratamiento de conductos para conservar piezas naturales mediante desinfección, conformación y sellado del conducto",
                    provider: {
                        name: "Dental City",
                        address: {
                ...
                <section className="relative overflow-hidden bg-gradient-to-b from-[#0f2237] via-[#0b1b2b] to-[#0f2237]">
                    ...
                    <Container className="py-16 md:py-24 relative z-10">
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            >
                                Tratamiento de conductos para conservar piezas naturales. Salva tu diente y evita la extracción con este procedimiento especializado.
                            </motion.p>
                        </div>
                    </Container>
                </section>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            >
                                ...
                                <div className="space-y-4 text-white/80 leading-relaxed text-lg">
                                    ...
                                    <p>
                                        Este tratamiento es necesario cuando la pulpa dental se inflama o infecta debido a caries profundas, fracturas, o traumatismos. En Dental City realizamos <strong className="text-[#e4b892]">desinfección</strong>, <strong className="text-[#e4b892]">conformación</strong> y <strong className="text-[#e4b892]">sellado del conducto</strong> con técnicas avanzadas para garantizar el éxito del tratamiento.
                                    </p>
                                </div>
                            </motion.div>
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: "Evaluación del diente y aplicación de anestesia local para garantizar tu comodidad durante el procedimiento."
                                        },
                                        {
                                            step: "2",
                                            title: "Apertura y Acceso",
                                            desc: "Se realiza una pequeña apertura en la corona del diente para acceder a la pulpa y los conductos radiculares."
                                        },
                                        {
                                            step: "3",
                                            title: "Limpieza y Desinfección",
                                            desc: "Se remueve la pulpa infectada y se limpian y desinfectan completamente los conductos radiculares."
                                        },
                                        {
                                            step: "4",
                                            title: "Conformación y Sellado",
                                            desc: "Los conductos se conforman y se sellan con material especial para prevenir futuras infecciones."
                                        },
                                        {
                                            step: "5",
                                            title: "Restauración Final",
                                            desc: "El diente se restaura con una corona o resina para protegerlo y restaurar su funcionalidad."
                                        }
                                    ].map((item, idx) => (
                                        <motion.div
                                            key={idx}
                            ...
                            >
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-white/80">60-120 minutos</p>
                                        <p className="text-white/80 text-sm">(1-2 citas según el caso)</p>
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold text-[#e4b892] mb-2">Precio Estimado</h3>
                                        <p className="text-white/80">$4,900 MXN</p>
                            ...
                            >
                                <a
                                    href={getWaUrl("endodoncia", "Endodoncia")}
                                    target="_blank"
