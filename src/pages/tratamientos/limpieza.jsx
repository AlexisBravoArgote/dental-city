// src/pages/tratamientos/limpieza.jsx
...
export default function Limpieza() {
    ...
    const getWaUrl = (serviceKey, serviceTitle) => {
        ...
        const text = encodeURIComponent(`Hola me gustaria agendar una cita para ${serviceTitle || "limpieza dental"}`);
    ...
    return (
        <>
            <SEO
                title="Limpieza Dental | Dental City"
                description="Limpieza dental profesional en Zapopan, Guadalajara. Profilaxis completa con remoción de placa, sarro y pulido. Prevención de enfermedades periodontales. Agenda tu cita."
                keywords="limpieza dental, profilaxis dental, limpieza Zapopan, limpieza Guadalajara, remoción de placa, remoción de sarro, higiene dental, prevención dental"
            />
            <StructuredData
                type="MedicalProcedure"
                data={{
                    name: "Limpieza Dental",
                    description: "Profilaxis profesional para mantener encías y dientes sanos mediante remoción de placa, sarro y pulido",
                    provider: {
                        name: "Dental City",
                        address: {
                ...
                <section className="relative overflow-hidden bg-gradient-to-b from-[#0f2237] via-[#0b1b2b] to-[#0f2237]">
                    ...
                    <Container className="py-16 md:py-24 relative z-10">
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            >
                                Profilaxis profesional para mantener encías y dientes sanos. La base de una salud bucal óptima y una sonrisa radiante.
                            </motion.p>
                        </div>
                    </Container>
                </section>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            >
                                <h2 className="text-3xl md:text-4xl font-bold mb-8 text-white">
                                    <span className="bg-gradient-to-r from-[#c89b7b] via-[#e4b892] to-[#c89b7b] bg-clip-text text-transparent">
                                        ¿Qué incluye la limpieza dental?
                                    </span>
                                </h2>
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: "Eliminación completa de placa bacteriana y sarro acumulado en la superficie de los dientes y debajo de la línea de las encías mediante instrumentos especializados."
                                        },
                                        {
                                            step: "2",
                                            title: "Pulido Dental",
                                            desc: "Pulido de las superficies dentales para eliminar manchas y dejar los dientes lisos, dificultando la acumulación futura de placa."
                                        },
                                        {
                                            step: "3",
                                            title: "Aeropulidor (Opcional)",
                                            desc: "Técnica avanzada que utiliza un chorro de agua con bicarbonato de sodio para eliminar manchas superficiales y lograr una limpieza más profunda."
                                        },
                                        {
                                            step: "4",
                                            title: "Aplicación de Flúor",
                                            desc: "En algunos casos, se aplica flúor para fortalecer el esmalte dental y prevenir la formación de caries."
                                        }
                                    ].map((item, idx) => (
                                        <motion.div
                                            key={idx}
                            ...
                            >
                                <h2 className="text-2xl md:text-3xl font-bold mb-4 text-white">
                                    <span className="bg-gradient-to-r from-[#c89b7b] via-[#e4b892] to-[#c89b7b] bg-clip-text text-transparent">
                                        ¿Con qué frecuencia debo hacerme una limpieza?
                                    </span>
                                </h2>
                                <p className="text-white/80 leading-relaxed text-lg mb-4">
                                    Se recomienda realizar una limpieza dental profesional cada <strong className="text-[#e4b892]">6 meses</strong>. Sin embargo, en casos de enfermedad periodontal o acumulación excesiva de sarro, tu dentista puede recomendar limpiezas más frecuentes, cada 3-4 meses.
                                </p>
                            ...
                            >
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-white/80">45 minutos aproximadamente</p>
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold text-[#e4b892] mb-2">Precio Estimado</h3>
                                        <p className="text-white/80">$1,200 MXN (limpieza general)</p>
                                        <p className="text-white/80">$1,500 MXN (con aeropulidor)</p>
                            ...
                            >
                                <a
                                    href={getWaUrl("limpieza", "Limpieza Dental")}
                                    target="_blank"
