// src/pages/tratamientos/maxilofacial.jsx
...
export default function Maxilofacial() {
    const { t } = useTranslation("home");
    const navigate = useNavigate();

    const getWaUrl = (serviceKey, serviceTitle) => {
        const base = "https://wa.me/523333087833";
        const text = encodeURIComponent(`Hola me gustaria agendar una cita para ${serviceTitle || "cirugía maxilofacial"}`);
    ...
    return (
        <>
            <SEO
                title="Cirugía Maxilofacial | Dental City"
                description="Cirugía maxilofacial en Zapopan, Guadalajara. Procedimientos quirúrgicos especializados de alta precisión. Extracciones, implantes, cirugía ortognática. Consulta nuestros precios."
                keywords="cirugía maxilofacial, cirugía oral, extracciones dentales, cirugía ortognática, cirugía Zapopan, cirugía Guadalajara"
            />
            <StructuredData
                type="MedicalProcedure"
                data={{
                    name: "Cirugía Maxilofacial",
                    description: "Procedimientos quirúrgicos especializados de alta precisión con plan quirúrgico personalizado y control del dolor",
                    provider: {
                        name: "Dental City",
                        address: {
                ...
                <section className="relative overflow-hidden bg-gradient-to-b from-[#0f2237] via-[#0b1b2b] to-[#0f2237]">
                    ...
                    <Container className="py-16 md:py-24 relative z-10">
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            >
                                Procedimientos quirúrgicos especializados de alta precisión. Soluciones avanzadas para problemas complejos de la boca, mandíbula y cara.
                            </motion.p>
                        </div>
                    </Container>
                </section>
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            >
                                ...
                                <div className="space-y-4 text-white/80 leading-relaxed text-lg">
                                    ...
                                    <p>
                                        En Dental City realizamos procedimientos quirúrgicos especializados con <strong className="text-[#e4b892]">plan quirúrgico personalizado</strong> y <strong className="text-[#e4b892]">control del dolor</strong> avanzado. Nuestros cirujanos maxilofaciales están altamente capacitados para realizar desde extracciones complejas hasta cirugías reconstructivas.
                                    </p>
                                </div>
                            </motion.div>
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: "Análisis completo con radiografías y estudios de imagen para planificar el procedimiento quirúrgico adecuado."
                                        },
                                        {
                                            step: "2",
                                            title: "Plan Quirúrgico Personalizado",
                                            desc: "Desarrollo de un plan quirúrgico específico para tu caso, considerando todos los factores relevantes."
                                        },
                                        {
                                            step: "3",
                                            title: "Procedimiento Quirúrgico",
                                            desc: "Cirugía realizada con técnicas avanzadas, anestesia adecuada y control del dolor durante todo el proceso."
                                        },
                                        {
                                            step: "4",
                                            title: "Seguimiento y Recuperación",
                                            desc: "Control postoperatorio y recomendaciones para una recuperación óptima y sin complicaciones."
                                        }
                                    ].map((item, idx) => (
                                        <motion.div
                                            key={idx}
                            ...
                            >
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-white/80">45-120 minutos según procedimiento</p>
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold text-[#e4b892] mb-2">Precio Estimado</h3>
                                        <p className="text-white/80">$5,000 - $25,000+ MXN</p>
                                        <p className="text-sm text-white/60 mt-1">*Precio varía según complejidad del caso</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            >
                                <a
                                    href={getWaUrl("maxilofacial", "Cirugía Maxilofacial")}
                                    target="_blank"
